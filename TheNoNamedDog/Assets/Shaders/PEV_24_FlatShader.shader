    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 normalDirection = lerp(normalize(cross(ddy(i.posWorld.rgb),ddx(i.posWorld.rgb))),mul( unity_ObjectToWorld, float4(i.normalDir,0) ).xyz.rgb,_SmoothNormal);
